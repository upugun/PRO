var meetingApp = angular.module("locationModule", [ 'ui.bootstrap' ]);
...
var locationController = [
		...
		function($scope, $cookieStore, $rootScope, $http, constantService,
			...
			function fetch() {
				// fetch meeting rooms
				locationService.getLocations("searchByStatus", $scope.locationStatus).then(function(response) {
...
meetingApp.controller("locationController", locationController);